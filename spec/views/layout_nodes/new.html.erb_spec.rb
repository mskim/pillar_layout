...
RSpec.describe "layout_nodes/new", type: :view do
  before(:each) do
    assign(:layout_node, LayoutNode.new(
      :direction => "MyString",
      :grid_x => 1,
      :grid_y => 1,
      :column => 1,
  ...
  it "renders new layout_node form" do
    render

    assert_select "form[action=?][method=?]", layout_nodes_path, "post" do
