...
RSpec.describe "page_layouts/new", type: :view do
  before(:each) do
    assign(:page_layout, PageLayout.new(
      :doc_width => 1.5,
      :doc_height => 1.5,
      :ad_type => "MyString",
      :page_type => "MyString",
  ...
  it "renders new page_layout form" do
    render

    assert_select "form[action=?][method=?]", page_layouts_path, "post" do
