...
class YhArticleDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how yh articles are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(yh_article)
  #   "YhArticle ##{yh_article.id}"
  # end
end
