module RLayout
  class CaptionParagraph
    ...
    attr_accessor :space_width, :comic_caption
    def initialize(options={})
      @comic_caption  = options[:comic_caption]
    ...
    def make_caption_title_tokens
      ...
      @caption_title_style  = @current_style['comic_caption_title'] if @comic_caption
    ...
    def make_caption_tokens
      ...
      @caption_title_style  = @current_style['comic_caption'] if @comic_caption
    ...
    def make_source_tokens
      ...
      @caption_title_style  = @current_style['comic_source'] if @comic_caption
